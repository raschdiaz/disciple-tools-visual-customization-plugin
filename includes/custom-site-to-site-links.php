...
class DT_Visual_Customization_Plugin_Site_Links {
    public $type = 'dt_visual_customization_plugin';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Visual Customization' );
        return $type;
    }
}
DT_Visual_Customization_Plugin_Site_Links::instance();
